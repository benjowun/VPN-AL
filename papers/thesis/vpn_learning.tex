...
\todo[inline]{Add a terminology section here that maps to the L* and KV definitions previously and in qhich we finally agree on some terms, such as inputs instead of words.}
