...
\cleardoublepage
\input{thesis-embed}          %   Chapter 2

\cleardoublepage
\input{thesis-struc}          %   Chapter 3

\cleardoublepage
\input{thesis-academic}       %   Chapter 4

\cleardoublepage
\input{thesis-style}          %   Chapter 5

\cleardoublepage
\input{thesis-presentations}  %   Chapter 6
